oS.Init({
    ...
    backgroundImage: "images/interface/logo1.png",
    LoadAccess: function(a) {
        NewEle(0, "div", "width:225px;height:44px;margin:550px 0 0 694px;position:absolute;z-index:1;", 0, $("tGround"));
        EBody = document.body;
